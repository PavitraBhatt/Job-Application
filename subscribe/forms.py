...
#     first_name = forms.CharField(max_length=100,required=False,label="Enter first name",help_text="Enter charachters only")
...
#     email = forms.EmailField(max_length=100)
    ...
    #     if "," in data:
    #         raise forms. ValidationError("Invalid Firsrt Name")
    #     return data
